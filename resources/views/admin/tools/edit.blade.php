                    ...
                    <form action="{{ route('tools.update', $tool->id) }}" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="row"> 
                            <div class="col-md-6 mb-3"> 
                                ...
                                <input type="number" name="stok" class="form-control @error('stok') isinvalid @enderror" value="{{ old('stok', $tool->stok) }}" min="0" required> 
                            </div> 
                             
                            <div class="col-md-6 mb-3"> 
                                <label class="form-label">Ganti Gambar (Opsional)</label> 
                                <input type="file" name="gambar" class="form-control @error('gambar') isinvalid @enderror" accept="image/*"> 
                                @if($tool->gambar) 
                                    <div class="mt-2"> 
